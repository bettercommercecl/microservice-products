...
export interface BigCommerceProduct {
  ...
  /** Disponible cuando se incluye 'channels' en el query param include */
  channels?: number[]
  /** Disponible cuando se incluye 'variants' en el query param include */
  variants?: BigCommerceProductVariant[]
  /** Disponible cuando se incluye 'images' en el query param include */
